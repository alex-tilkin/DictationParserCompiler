...
public interface DictationParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link DictationParserParser#arguments}.
	 * @param ctx the parse tree
	 */
	void enterArguments(DictationParserParser.ArgumentsContext ctx);
	/**
	 * Exit a parse tree produced by {@link DictationParserParser#arguments}.
	 * @param ctx the parse tree
	 */
	void exitArguments(DictationParserParser.ArgumentsContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link DictationParserParser#methodRef}.
	 * @param ctx the parse tree
	 */
	void enterMethodRef(DictationParserParser.MethodRefContext ctx);
	/**
	 * Exit a parse tree produced by {@link DictationParserParser#methodRef}.
	 * @param ctx the parse tree
	 */
	void exitMethodRef(DictationParserParser.MethodRefContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link DictationParserParser#implementsExtends}.
	 * @param ctx the parse tree
	 */
	void enterImplementsExtends(DictationParserParser.ImplementsExtendsContext ctx);
	/**
	 * Exit a parse tree produced by {@link DictationParserParser#implementsExtends}.
	 * @param ctx the parse tree
	 */
	void exitImplementsExtends(DictationParserParser.ImplementsExtendsContext ctx);
	/**
